          ...
          <div className="pt-6 mt-2 border-t border-border">
            ...
            <div className="mt-8 rounded-xl border border-primary/20 bg-primary/5 p-5 sm:p-6">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-5">
                <Link
                  to="/discount"
                  className="btn-primary text-sm active:scale-[0.97] transition-transform duration-150 ease-emil"
                >
                  Claim 3 months of Pro — $20 <ArrowRight size={14} />
                </Link>
                <span className="text-xs text-muted">
                  Works today on the web · no subscription · 14-day refund
                </span>
              </div>
              <div className="text-[11px] uppercase tracking-[0.14em] text-muted mb-2">
                Or get your result by email
              </div>
              {emailState === 'done' ? (
